...
<div class="space-y-8">
	...
	{:else if health}
		...
		<div class="grid grid-cols-3 gap-6">
			...
			<!-- Rake -->
			<div class="kpi-card rake opacity-50">
				<div class="flex items-center justify-between mb-4">
				...
				<div class="space-y-2">
					...
					<div class="w-full bg-forge-steel/20 rounded-full h-2"></div>
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div class="grid grid-cols-3 gap-6">
				...
				<div class="nav-card rake opacity-50 cursor-not-allowed">
					<h3 class="text-xl font-semibold text-rake mb-2">Rake</h3>
					<p class="text-forge-steel text-sm">
						Pipeline status, ingestion metrics, and data flow monitoring
					</p>
					<span class="text-xs text-forge-steel mt-2 block">Coming soon</span>
				</div>
			</div>
		</div>
