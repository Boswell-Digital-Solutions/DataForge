...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/FTESYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/FTESYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/FTESYSTEM.md\`" "assembled primary output"
